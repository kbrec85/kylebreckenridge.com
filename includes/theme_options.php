<?php
function _kb__setup_theme_admin_menus() {
    add_submenu_page('themes.php', 'Theme Options', 'Theme Options', 'manage_options', 'theme-options', '_kb__theme_options_page');
}
add_action("admin_menu", "_kb__setup_theme_admin_menus");
...
function _kb__theme_options_page() {
