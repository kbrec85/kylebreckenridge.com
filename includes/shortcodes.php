<?php
function _kb__full_address_shortcode( $atts ) {
...
add_shortcode( 'full-address', '_kb__full_address_shortcode' );

function _kb__street_address_shortcode( $atts ) {
	$street_address = get_option("street_address");
    $street_address_2 = get_option("street_address_2");
    $city = get_option("city");
    $state = get_option("state");
...
add_shortcode( 'full-address', '_kb__street_address_shortcode' );

function _kb__phone_shortcode( $atts ){
	$phone = get_option("phone");
	echo $phone;
}
add_shortcode( 'full-address', '_kb__phone_shortcode' );
?>